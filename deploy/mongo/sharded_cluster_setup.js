...
db.createCollection("socialDB.review_ratings")
db.createCollection("socialDB.review_assessments")
sh.shardCollection("socialDB.movieLikes", {"movie_id": "hashed"})
sh.shardCollection("socialDB.review_ratings", {"review_id": "hashed"})
sh.shardCollection("socialDB.review_assessments", {"user_id": "hashed"})