...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['user_role_id'], ['auth.user_role.id'], name=op.f('fk__user_info__user_role_id__user_role')),
    ...
    sa.Column('session_type', sa.Enum('NATIVE', name='usersessiontype', schema='auth', inherit_schema=True), nullable=True),
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['user_info_id'], ['auth.user_info.id'], name=op.f('fk__user_session__user_info_id__user_info')),
