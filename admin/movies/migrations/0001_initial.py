...
def get_sql_dump_text() -> str:
    file_path = os.path.join(os.path.dirname(__file__), 'dump.sql')
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.FloatField(blank=True, validators=[django.core.validators.MinValueValidator(0),
                                             ...
                                             verbose_name='rating')),
                ('type',
                 models.CharField(choices=[('movie', 'Movie'), ('tv_show', 'TV Show')], default='movie', max_length=255,
                                  verbose_name='type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role',
                 models.CharField(choices=[('режиссер', 'Director'), ('актер', 'Actor'), ('сценарист', 'Writer')],
                                  max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.RunSQL(get_sql_dump_text()),
    ]
